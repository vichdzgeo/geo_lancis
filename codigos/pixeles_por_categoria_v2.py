...
dicc_capas = {'capa_1':{'ruta':'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/analisis_aptitud/sectores/urbano/fv/procesamiento/apt_urbano_sigindex_equidistante_exclusion.tif'},
              'capa_2':{'ruta':'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/analisis_aptitud/sectores/urbano/fv/humedales_utm16_presencia.tif'}
            }

path_csv = path_sig+'categorias_'+nombre_capa(dicc_capas['capa_1']['ruta'])+'.csv'
categorias = int(raster_max(dicc_capas['capa_1']['ruta']))
matriz = matriz_transicion(dicc_capas,2,path_csv)
print ("terminando  ",time.strftime("%H:%M:%S"))