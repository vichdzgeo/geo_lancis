...
path_sig = 'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_papiit/procesamiento/aptitud_turistica__costera_yuc/procesamiento/owa/'

dicc_capas = {'capa_1':{'ruta':path_sig+'clasificaciones/aptitud_turistica_con_anp_owa_00001_equidistante.tif'},
              'capa_2':{'ruta':path_sig+'clasificaciones/aptitud_turistica_con_anp_owa_00001_equidistante.tif'}
            }

path_csv = path_sig+'clasificaciones/categorias_'+nombre_capa(dicc_capas['capa_1']['ruta'])+'.csv'
