...
def main():
                                ...
                                'criterios':{'biologico':{'w':0.50 ,
                                            ...
                                            'fisico':{'w':0.50,
                                                            'criterios':{'ancho_playa_res':{'w':0.62,'ruta':p_sig_res + 'fisica/ancho_playa_yuc/fv_ancho_playa_yuc_100m.tif'},
                                                                        ...
                                                                        'tipo_litoral_res':{'w':0.05,'ruta':p_sig_res + 'fisica/t_litoral_yuc/fv_tipo_litoral_yuc_100m_corregida.tif'}
                                                                        }
                                                    }
                                            }
                        }
    ...
    for fp in factor_progresion:
        ...
        csv_nuevos_promedios = p_sig +'entregables/analisis_vulnerabilidad_costera/sensibilidad_tau_nueva/'+factor_v+'/etapa_1/cat_'+cat+'/bd_'+factor_v[0:3]+'_nueva_fv_prom_'+fp+'.csv'
