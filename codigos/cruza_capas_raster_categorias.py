...
path_sig  = path_directorio = 'C:/vulnerabilidad10/'

## insumos###
dicc_capas = {'capa_1':{'ruta':'C:/vulnerabilidad10/tmp/tp_silvopastoril_equidistante.tif'},
              'capa_2':{'ruta':'C:/vulnerabilidad10/tmp/tp_silvopastoril_sin_mercados_loc_equidistante.tif'}
            }

path_csv = path_sig +'silvopastoril_vs_sin_mercados_locales.csv'
