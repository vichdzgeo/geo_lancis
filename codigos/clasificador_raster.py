...
def clasifica_raster(path_capa,clasificador,path_categorizado,fp=2,categories=5,):
    ...
    path_salida_tp = path_categorizado +nombre_capa(path_capa).split(".")[0]+"tp_"+nombre+".tif"
    path_salida = path_categorizado + nombre_capa(path_capa).split(".")[0]+"_"+nombre+".tif"
    dicc ={        
        'INPUT_A':path_capa,
        'BAND_A':1,
        'FORMULA':ecuacion,
...
def get_region_extent(path_layer):
    '''
