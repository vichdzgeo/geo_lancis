...
def main():
    ...
    ruta = 'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/analisis_aptitud/politetico_divisivo/grass/grupos_100m_sin_acu_pesca_fo/'
    capas = [
    ...
    corte =getPuntoDeCorte2(data) # regresa el intervalo que sera el corte
    print(nombre_pca,"corte en ",corte)
