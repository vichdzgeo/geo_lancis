...
def siguiente_corte(capas,capa_pca,name_pca,ruta):
    ...
    print("corta a:insumos",insumos_a)
    print("corta b:insumos",insumos_b)

    nombre_pca = name_pca+'a'
    capas_input = capas_i(insumos_a)
    capa_pca= pca(capas_input,nombre_pca,ruta)
    data = stadistica(capa_pca,ruta)
    print(capa_pca)
    nombre_pca = name_pca+'b'
...
#sys.path.insert(0, os.path.abspath('C:/Dropbox (LANCIS)/CARPETAS_TRABAJO/vhernandez/geo_lancis/codigos/secundarios/'))