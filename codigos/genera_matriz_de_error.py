...
def matriz_transicion(dicc_capas,categorias,cat_min,cat_max,path_csv):
...
dicc_capas = {'capa_1':{'ruta':'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/analisis_aptitud/sectores/urbano/fv/urb_urbano.tif'},
              'capa_2':{'ruta':'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/analisis_aptitud/sectores/urbano/fv/urb_urbano.tif'}
            }
...
matriz = matriz_transicion(dicc_capas,categorias,int(cat_min),int(cat_max),path_csv)
fin = time.time()
