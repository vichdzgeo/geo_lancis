...
## insumos###
dicc_capas = {'capa_1':{'ruta':path_insumos +"procesamiento/carreteras/fv_carreteras.tif",'w':0.27},
            'capa_2':{'ruta':path_insumos +"procesamiento/anp/fv_anp_yuc.tif",'w':0.04},
            'capa_3':{'ruta':path_insumos +"procesamiento/distancia_costa/fv_distancia_costa_yuc.tif",'w':0.55},
            'capa_4':{'ruta':path_insumos +"procesamiento/localidades_costeras/fv_localidades_costeras.tif",'w':0.13},
            }
...
path_salida = path_insumos+"procesamiento/owa/"
