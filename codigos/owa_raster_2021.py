...
path_datos = 'C:/Dropbox (LANCIS)/FOMIX/fmx_estudio_tecnico/diagnostico/talleres/sectores/milpa_apic/funciones_valor/sensibilidad_milpa_maya.csv'
dicc_capas = csv_to_dicc_owa(path_datos)
sector = 'milpa_maya_'

### Ruta de capa maestra, puede ser cualquiera de los insumos ###
path_capa_maestra= 'C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/entregables/mascara_municipios_2018/area_municipios_2018_yuc.tif'
## Ruta del directorio donde se almacenarán las salidas 
path_salida = "C:/Dropbox (LANCIS)/SIG/desarrollo/sig_fomix/procesamiento/pruebas/owa/"+sector
...
a = "C:/Dropbox (LANCIS)/CARPETAS_TRABAJO/apc_temeraria/owa/insumos/area_municipios_2018_yuc.tif"
