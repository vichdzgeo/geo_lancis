...
def calculo_owa(df,w,alpha=0.5): # 6 de 9
    ...
    df[campo_owa] = df.apply(lambda x: owa_df(x['v'],w,alpha),axis=1)
...
path_datos = 'C:/Dropbox (LANCIS)/FOMIX/fmx_estudio_tecnico/diagnostico/talleres/sectores/pec_bovino/funciones_valor/sensibilidad_bovino.csv'
